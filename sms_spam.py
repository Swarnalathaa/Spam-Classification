...
# tranforming text to array of numbers
...
for n,c  in spam_classifier.items():
    ...
    summary_count.append((n,[accuracy, precision, recall]))
    print("Confusion Matrix of  str(n) :\n", confusion_matrix)

result_summary_count =  pd.DataFrame.from_items(summary_count,orient='index', columns=['Accuracy', 'Precision', 'Recall'])
print(result_summary_count)
